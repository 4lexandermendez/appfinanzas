...
export async function crearTransaccion({ categoriaId, monto, fecha, notas, fuente, tarjetaId }) {
  const { data } = await client.post("/transacciones", { categoriaId, monto, fecha, notas, fuente, tarjetaId });
